...
{
    public partial class Case4001Form : Form
    {
        ...
        public Case4001Form(BaseForm baseForm, bool isApplicant, CaseMstEntity caseMST, CaseSnpEntity caseSNP, string mode, PrivilegeEntity privilegeEntity, List<CaseSnpEntity> CaseSnpEntityProp, string strApplicantLastName)
        {
            InitializeComponent();
        ...
        private void OnMaxMinClick(object sender, EventArgs e)
        {
            ...
            {
                splitApplicant.SplitterDistance = 391;
                customFieldsControl.IsMax = false;
        ...
        Gizmox.WebGUI.Forms.Form _case4001Form;
        ...
        private void Case4001Form_FormClosing(object sender, FormClosingEventArgs e)
        {
            if (!Mode.Equals(Consts.Common.View))
            {
                if (string.IsNullOrEmpty(Refresh_Control))
                {
                    ...
                    _case4001Form = (Gizmox.WebGUI.Forms.Form)sender;
